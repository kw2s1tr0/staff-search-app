...
class SearchOutputBuilderTest extends TestCase
{
    ...
    public function test_it_builds_an_employee_without_a_position(): void
    {
        $departmentRecord = new EmployeeSearchDepartmentOutputRecord(
            id: 1,
            code: 'DEV',
        ...
        $employeeRecord = $this->createEmployeeRecord($departmentRecord, null);
        $repositoryOutput = new EmployeeSearchOutputRecord([$employeeRecord]);
        ...
        $this->assertNull($output->employees[0]->position);
    }
