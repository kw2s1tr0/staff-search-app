...
- Laravel app: `/ssapp/my-app`
- Docker config: `/ssapp/Docker`
- human/AI docs: `/ssapp/docs`
- PHP code: `my-app/app`
- routes: `my-app/routes`
- config: `my-app/config`
- database files: `my-app/database`
- tests: `my-app/tests/Feature` と `my-app/tests/Unit`
- frontend entrypoints: `my-app/resources/js` と `my-app/resources/css`
