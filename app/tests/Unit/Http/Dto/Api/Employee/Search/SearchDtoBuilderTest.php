...
namespace Tests\Unit\Http\Dto\Api\Employee\Search;
...
class SearchDtoBuilderTest extends TestCase
{
    ...
    public function test_it_builds_a_dto_without_a_position(): void
    {
        $department = new DepartmentOutput(
            id: 1,
            code: 'DEV',
        ...
        $this->assertNull($dtos[0]->position);
        $this->assertStringContainsString('"position":null', json_encode($dtos, JSON_THROW_ON_ERROR));
    }
}
